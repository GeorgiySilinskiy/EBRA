  ...
  <div>
    <v-card outlined>
      ...
      <v-card-actions>
        ...
        <v-btn text color="error" small @click="deleteSecCat({id:item.id, specId: $route.params.id})">Удалить</v-btn>
      </v-card-actions>
    </v-card>
...
export default {
  ...
  methods: {
    ...mapActions({
      deleteSecCat: 'spec/deleteSpecItem',
      editSecCat: 'spec/editSpecItem'
    })
  }
}
</script>
